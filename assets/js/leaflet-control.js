...
L.Control.ZoomBar = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._zoomStartButton = this._createButton('', 'Zoom to Start Position', 'leaflet-control-zoom-to-start', container, this._zoomStart, this)
    ...
    if (this._isSmallScreen() === false) {
      this._zoomToAreaButton = this._createButton('', 'Zoom to Area', 'leaflet-control-zoom-to-area', container, this._zoomToArea, this)
    }
